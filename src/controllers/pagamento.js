...
exports.criarPagamento = async (req, res) => {
  try {
    ...
    // Dados de cartão de teste sandbox
    ...
    if (error.response) {
      return res.status(error.response.status).json({ message: "Erro na API do Asaas.", detalhe: error.response.data });
    }
